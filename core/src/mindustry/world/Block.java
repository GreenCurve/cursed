...
public class Block extends UnlockableContent{
    ...
    public void setBars(){
        ...
        bars.add("temperature", entity -> new Bar(() -> Core.bundle.format("bar.temperature",
                (Math.round(entity.heat().getTemperature() * 10) / 10f - 273)), () -> Pal.heat, () -> (float) entity.heat().overheatRate()));
